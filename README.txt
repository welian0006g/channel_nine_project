...
For testing scripts simply run "npm test" under the project root. Note that you might need to install Mocha 
globally first in order to run this testing command. Please run npm install mocha -g first if you haven't done 
so.
